...
public class BasicArgumentBaked implements ArgumentBaked {
	...
	public BasicArgumentBaked(ArgumentType type, int index, VariableElement element, MethodBaked parent) {
		this.type = type;
		this.parent = parent;
		this.index = index;
	...
	public BasicArgumentBaked(ArgumentBuilder builder, int index, MethodBaked parent) {
		this(builder.getArgumentType(), index, builder.getElement(), parent);
	}
